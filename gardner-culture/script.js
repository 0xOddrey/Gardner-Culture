...
const policies = [
  ...
  },
  {
    ...
    sections: [
      ...
      ['Compassionate and bereavement leave', ['Compassionate leave is a statutory entitlement under section 25 of the Labour Act when there is a death or serious illness involving a qualifying family member. For this policy, bereavement leave means compassionate leave taken following the death of a qualifying family member.', 'The qualifying family relationships are:', ['A child, including a child adopted under any law, custom, or tradition.', 'A spouse.', 'A parent or grandparent of the employee.', 'A brother or sister of the employee.', 'A father-in-law or mother-in-law of the employee.'], 'These relationships determine eligibility under section 25. Leave for a death or serious illness involving one of these family members is not a discretionary special-circumstance request, provided the employee meets the statutory application and evidence requirements.', 'The employee must follow the prescribed application process and provide reasonable evidence of the serious illness or death and the qualifying relationship. Where advance application is impossible, the employee must notify the school of the absence and intended duration as soon as reasonably possible, then submit the required application and evidence promptly afterwards.']],
  ...
  },
  {
    ...
    sections: [
      ...
      ['Reporting', ['Every staff member has a duty to report any corporal punishment they witness. Any observed, disclosed, or suspected corporal punishment, degrading treatment, or inappropriate physical intervention must be reported immediately to the designated safeguarding lead or school head. Staff must record facts and must not investigate the allegation themselves.']]
    ]
  },
  {
  ...
  },
  {
    ...
    sections: [
      ...
      ['Prohibited conduct', ['Staff may not:', ['Consume alcohol or use illegal drugs and then report for duty, or consume alcohol or use illegal drugs while on duty.', 'Possess, use, distribute, or sell prohibited substances on school property or while on school duty.', 'Smoke or vape on school property, near students, in school vehicles, or during a school activity.', 'Fail to report a colleague they know or reasonably believe has consumed alcohol or used illegal drugs before reporting for duty or while on duty. Every employee has this reporting responsibility as part of safeguarding.']]],
